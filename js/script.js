...
//   // New Code: Variables ko seedhe 'name' aur 'email' naam se bhej raha hai
//   .send("service_rnrkvws", "template_k73cvrs", {
//     name: document.getElementById("name").value, // Fixed! Now matches {{name}}
//     email: document.getElementById("email").value, // Fixed! Now matches {{email}}
//     phone: document.getElementById("phone").value,
//     subject: document.getElementById("subject").value,
//     message: document.getElementById("message").value,
//    })
...
// ----------------------------
// 📩 EmailJS Integration (v3) ✅ FIX APPLIED HERE
// ----------------------------
...
document.getElementById("contact-form").addEventListener("submit", function (e) {
    ...
    // Collect data - Variables changed to match the template: 'name' and 'email'
    const params = {
